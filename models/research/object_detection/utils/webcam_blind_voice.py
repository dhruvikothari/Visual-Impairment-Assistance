...
PATH_TO_CKPT = 'models/research/object_detection/builders/ssd_mobilenet_v1_coco_11_06_2017/frozen_inference_graph.pb'
...
#     try:
#         opener.retrieve(DOWNLOAD_BASE + MODEL_FILE, MODEL_FILE)
#         os.system(f'tar -zxvf {MODEL_FILE}')  # Extract the contents of the downloaded file
#     except urllib.error.HTTPError as e:
#         print(f'Error downloading the model: {e}')
# else:
#     print('Model already exists')
